...
#pydnatic model to validate the input data
class UserInput(BaseModel):
    age: Annotated[int, Field(..., gt=0, lt=120, description="Age of the user")]
    weight: Annotated[float, Field(..., gt=0, lt=100, description="Weight of the user")]
    ...
    city: Annotated[str, Field(..., max_length=100, description="City of residence")]
